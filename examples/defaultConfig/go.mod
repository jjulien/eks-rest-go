module github.com/jjulien/eks-rest-go/examples/defaultConfig

go 1.18

replace github.com/jjulien/eks-rest-go => ../..

require (
	github.com/jjulien/eks-rest-go v0.0.0-00010101000000-000000000000
